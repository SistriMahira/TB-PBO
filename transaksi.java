...
public class transaksi extends barang {
    ...
    String urll = "jdbc:mysql://localhost:3306/pbodbjasuke";
    ...
    public void view()throws SQLException{   //vieeewwww
        ...
        System.out.println("Daftar menu jasuke");
        String sql = "SELECT * FROM jasuke";
    ...
    public void save() throws SQLException{//menyimpan data
        ...
        try{
            ...
            String sql = "INSERT INTO jasuke (nobarang, namabarang, ukuranbarang, harga, jumlah) VALUES ('"+kodebarang+"','"+namabrg+"','"+ukurannya+"','"+hargabrg+"' ,'"+jumlahbrg+"')";
    ...
    public void delete() throws SQLException{
        ...
        view();
        try{
            System.out.print("Masukkan nomor barangang akan dihapus : ");
            String keyword = inputan.next();

            String sql = "DELETE FROM jasuke WHERE nobarang = '"+ keyword+"'";

            conn = DriverManager.getConnection(urll,"root","");
	        Statement statement = conn.createStatement();

            if(statement.executeUpdate(sql) > 0){
	            System.out.println("Berhasil menghapus data jasuke (Nomor "+keyword+")");
	        }
        }
    ...
    public void search() throws SQLException{
		...
		String sql = "SELECT * FROM jasuke WHERE namabarang LIKE '%"+keyword+"%'";
		conn = DriverManager.getConnection(urll,"root","");
        Statement statement = conn.createStatement();
        ResultSet result = statement.executeQuery(sql); 
    ...
    public void update() throws SQLException{
        ...
        try{
            ...
            String sql = "SELECT * FROM jasuke WHERE nobarang = '"+ keywordd+"'";
            Statement statement = conn.createStatement();
            ResultSet result = statement.executeQuery(sql);
            ...
            if (result.next())
            {
                ...
                System.out.print("\n");
                sql = "UPDATE jasuke SET namabarang='"+namabarubrg+"' WHERE nobarang='"+keywordd+"'";
                sql = "UPDATE jasuke SET jumlah='"+tambahan2+"' WHERE nobarang='"+keywordd+"'";
    ...
    public void belibarang() throws SQLException{  //beli barang menggunakan konsep array list
        ...
        try {
            System.out.print("\nPilih nomor antrian yang akan di beli : ");
            pilihbarang = inputan.next();

            String sql = "SELECT * FROM jasuke WHERE nobarang = '"+ pilihbarang+"'";
            conn = DriverManager.getConnection(urll,"root","");
            Statement statement = conn.createStatement();
            ResultSet result = statement.executeQuery(sql);
            ...
            while (result.next())
            {
                ...
                barang.add(" Harga          : " + Integer.toString(result.getInt("harga")));  //method string         
            ...
            if (jumlablanja>jumlaa) {
                ...
                if (konfir.equals("yes")) {
                    ...
                    sql = "UPDATE jasuke SET jumlah='"+jumlaa+"' WHERE nobarang='"+pilihbarang+"'";
